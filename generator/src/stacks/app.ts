...
export async function run() {
  ...
  if (appOpts.type === 'Astro') {
    appOpts.astro.path = await consola.prompt(`Where should we generate ${colors.cyan('astro')} application?`, {
      type: 'text',
  ...
  if (appOpts.type === 'Next') {
    appOpts.next.path = await consola.prompt(`Where should we generate ${colors.cyan('application')}?`, {
      type: 'text',
  ...
  if (appOpts.type === 'Nuxt') {
    appOpts.nuxt.path = await consola.prompt(`Where should we generate ${colors.cyan('application')}?`, {
      type: 'text',
  ...
  if (appOpts.type === 'Vite') {
    appOpts.vite.path = await consola.prompt(`Where should we generate ${colors.cyan('application')}?`, {
      type: 'text',
  ...
  if (appOpts.type === 'Vue') {
    appOpts.vue.path = await consola.prompt(`Where should we generate ${colors.cyan('application')}?`, {
      type: 'text',
